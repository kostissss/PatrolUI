...
@Component({
  selector: 'app-assign-grid',
  templateUrl: './assign-grid.component.html',
  styleUrl: './assign-grid.component.css'
})
export class AssignGridComponent implements OnInit{
  @ViewChild('grid') grid!: AssignGridComponent;
