  ...
  public dialogButtons: Object = [
    {
      ...
      buttonModel : {
        content: 'Cancel',
        cssClass: 'border border-secondary col-sm-2 m-2 float-left text-lowercase font-weight-normal '
      }
    },{
      ...
      buttonModel : {
        ...
        content: 'Add',
        cssClass: 'border border-secondary m-2 col-sm-2 float-right text-lowercase font-weight-normal submit ',
