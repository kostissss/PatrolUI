  ...
  public dialogButtons: Object = [
    {
      ...
      buttonModel : {
        content: 'Cancel',
        cssClass: 'border border-secondary col-sm-2 m-2 p-0 float-left text-lowercase font-weight-normal '
      }
    },{
      ...
      buttonModel : {
        ...
        content: 'Apply',
        cssClass: 'border border-secondary m-2 p-0 col-sm-2 float-right text-lowercase font-weight-normal submit ',
